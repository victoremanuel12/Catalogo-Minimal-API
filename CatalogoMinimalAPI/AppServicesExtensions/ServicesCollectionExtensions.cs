...
{
    public static WebApplicationBuilder AddApiSwegger(this WebApplicationBuilder builder)
    {
    ...
    {
        var conectionString = builder.Configuration.GetConnectionString("DefaultConetion");
